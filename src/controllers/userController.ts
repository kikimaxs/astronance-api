...
// Import users from auth controller (in production, use shared database)
import { User } from '../types/auth';

// Struktur data yang dipisahkan per user owner
interface UserData extends Omit<User, 'password'> {
  ownerId: number; // ID dari user yang membuat data ini
}
